...
class Character:
    ...
    def attack(self) -> str:
        value_attack = DEFAULT_ATTACK + rnd(*self.RANGE_VALUE_ATTACK)
        return f'{self.name} нанёс противнику урон, равный {value_attack}'

    def defence(self) -> str:
        value_defence = DEFAULT_DEFENCE + rnd(*self.RANGE_VALUE_DEFENCE)
...
def start_training(char_class:Character):
    ...
    print(f'{char_class.name} - {char_class.BRIEF_DESC_CHAR_CLASS}')
